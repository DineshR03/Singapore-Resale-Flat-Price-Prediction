...
with _:
    st.empty()
    st.image('https://upload.wikimedia.org/wikipedia/commons/7/7d/Current-corporate-signature-.png',width=300)
    st.empty()
...
selected = option_menu ("Menu",
    ...
    styles={
        ...
        "nav-link": {"font-size": "18px","margin": "0px", "--hover-color": "#46B253"},
...
if selected == "Home":
    ...
    st.markdown('<h3 style="color:#2c3e50">HDB</h3>', unsafe_allow_html=True)
    st.markdown('''<p style='font-size:16px; color:#555555; line-height:1.6'>
    ...
    # History section
    st.markdown('<hr>', unsafe_allow_html=True)
    st.markdown('<h3 style="color:#2c3e50">History of HDB</h3>', unsafe_allow_html=True)
    st.markdown('''<ul style='font-size:16px; color:#555555; line-height:1.6'>
